...
| C8 | **The Online hero is flush to the header, and says too much.** The card's top edge sits at exactly 0px below the topstack, where every other content page leaves 64. And the hero carries a cap, a sentence about doors and light switches, a progress bar at zero and a paragraph of history. Jorge wants the sign and the headline only, and a gap above it. | Claude | `claude/mobile-site-optimization-qvei7u` | `src/Manager.jsx` | in review | #338 |
