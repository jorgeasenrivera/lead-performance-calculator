...
| C7 | **The under construction page says what the room is for, not what it is.** The Online room's page explains the mechanism in three bullets: where leads arrive from, how they are handed out, where the close counts. Jorge wants one line instead, saying the thing a manager would actually get out of it. The page itself stays. | Claude | `claude/mobile-site-optimization-qvei7u` | `src/Manager.jsx` | in review | #336 |
