...
if (typeof window !== "undefined") {
  window.addEventListener("pointerdown", (e) => { frLastTap.x = e.clientX; frLastTap.y = e.clientY; frLastTap.at = Date.now(); frLastTap.rect = null; }, { capture: true, passive: true });
}
