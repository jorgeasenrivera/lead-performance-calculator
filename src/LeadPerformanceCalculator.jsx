    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal guide-modal" onClick={(e) => e.stopPropagation()}>
        <div className="guide-modal-head">
          <h2 className="guide-title">How to pull the Delivery Summary</h2>
          <button className="btn-x" onClick={onClose}>✕</button>
        </div>
        <p className="guide-intro">Follow these three steps every time. The whole board depends on this one report being pulled correctly.</p>
        <DeliveryGuideSteps />
        <div className="guide-foot">
